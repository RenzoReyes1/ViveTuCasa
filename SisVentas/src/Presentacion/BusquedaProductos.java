...
public class BusquedaProductos extends java.awt.Dialog {
    ...
    public BusquedaProductos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarTable(){
        ...
        {
            cnn = Conexion.MySQL();
            ps = cnn.prepareStatement("SELECT productos.id_producto, productos.nombre_producto, categorias.nombre_categoria, marcas.nombre_marca, productos.precio_venta ,  productos.stock FROM productos "
    ...
    private void tblProductosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductosMousePressed
        if (evt.getClickCount() == 2){
            ...
            NuevaVenta.txtIdProducto.setText(id_producto);
            NuevaVenta.txtProducto.setText(producto);
            NuevaVenta.txtPrecio.setText(precio);
            NuevaVenta.txtStock.setText(stock);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BusquedaProductos dialog = new BusquedaProductos(new java.awt.Frame(), true);
